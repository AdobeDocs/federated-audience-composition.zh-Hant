---
title: Federated Audience Composition發行說明(2025)
description: 2025年同盟對象構成的發行說明。
...
* **輪廓擴充使用案例中的漸進式更新**
  ...
  有關使用儲存設定檔活動的詳細資訊，請參閱活動指南](/help/compositions/activities.md#save-profiles)的[儲存設定檔區段。
...
* **Amazon Redshift 安全連線**
  ...
  透過此新版本，同盟對象構成支援到Amazon Redshift資料庫的安全PrivateLink連線。 [了解更多](../connections/home.md#amazon-redshift)

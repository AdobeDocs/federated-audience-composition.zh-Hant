...
如需您可以詢問同盟對象構成的作業Insight問題的完整清單，請閱讀[作業深入分析區段](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/ai-assistant/home#operational-insights){target="_blank"}。

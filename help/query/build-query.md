...
1. 在想要的節點上選取&#x200B;**+**&#x200B;按鈕，然後選取&#x200B;**[!UICONTROL 自訂條件]**。 自訂條件屬性窗格會在右側開啟。

2. 在&#x200B;**[!UICONTROL Attribute]**&#x200B;欄位中，從資料庫中選取要用來建立條件的屬性。 屬性清單包含資料庫中的所有屬性，包括連結表格的屬性。

   ![](assets/query-custom-condition-fields.png){zoomable="yes"}

   >[!NOTE]
   >
   >**[!UICONTROL 編輯運算式]**&#x200B;按鈕可讓您利用運算式編輯器，使用資料庫和協助程式函式的欄位來手動定義運算式。 [了解如何編輯運算式](expression-editor.md)
...
4. 在「**[!UICONTROL 值]**」欄位中，定義預期的值。您也可以利用運算式編輯器，使用資料庫和協助程式函式的欄位，手動定義運算式。 若要這麼做，請選取&#x200B;**[!UICONTROL 編輯運算式]**&#x200B;按鈕。 [了解如何編輯運算式](expression-editor.md)
...
1. 在想要的節點上選取&#x200B;**+**&#x200B;按鈕，接著選取&#x200B;**[!UICONTROL 預先定義的篩選器]**。
...
1. 在元件的屬性窗格中選取&#x200B;**[!UICONTROL 複製]**&#x200B;按鈕；如果您已選取多個元件，請在熒幕底部的藍色功能區中選取。
...
若要變更用來將篩選條件連結在一起的運運算元，請選取該運運算元以及在右側開啟的&#x200B;**[!UICONTROL 群組]**&#x200B;窗格中所需的運運算元。
...
在畫布中建立查詢後，您可以使用右側的&#x200B;**[!UICONTROL 規則屬性]**&#x200B;窗格來檢查查詢。 建立查詢以建立客群時，會顯示此窗格。可用選項如下：
